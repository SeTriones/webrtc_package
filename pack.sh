...
find src/webrtc src/chromium/src/third_party/jsoncpp src/chromium/src/third_party/libyuv/ -name *.h -exec cp --parents '{}' ${headerdir} ';'
mv ${headerdir}/src/* ${headerdir}
mv ${headerdir}/chromium/src/third_party/jsoncpp/source/include/* ${headerdir}
mv ${headerdir}/chromium/src/third_party/libyuv/include/libyuv ${headerdir}
